...
Original file is located at
    https://colab.research.google.com/drive/18_AoZVHoQVXX_dQihre0ntwEbBcn2R1K
"""

# Eductional AI Application using IBM Granite Model
# Run this in Google Colab
!pip install transformers torch graiod -q
